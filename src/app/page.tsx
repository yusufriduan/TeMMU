  ...
  return (
    <TabGroup className={"flex flex-col items-center mt-10 gap-10"}>
        ...
        <div className='flex flex-row content-between items-center gap-6'>
          <TabList className={"flex gap-10 bg-(--foreground) rounded-4xl w-125 p-4"}>
            ...
            <div className={"flex"}> {/* Roles Exclusives */}
              <Tab className={" hidden rounded-4xl p-2 hover:bg-(--highlighted) hover:cursor-pointer data-selected:bg-(--highlighted) data-selected:text-black data-seleceted:font-bold"}>
                Find Mentors
              </Tab>
      ...
      <TabPanels>
        ...
        <TabPanel className={"hidden w-[90vw] h-[80vh] bg-(--foreground) rounded-4xl overflow-y-clip"}> {/* Find Mentors Container */}
        ...
        <TabPanel className={"w-[90vw] h-[80vh] bg-(--foreground) rounded-4xl"}>
          <div className='flex flex-row justify-between items-center h-full'> {/* Chats container */}
              ...
              <div className='flex flex-col flex-wrap gap-2 p-4 h-full'>
                ...
                <div className='flex flex-col align-top gap-4'>
                  ...
                  <div className='flex flex-row justify-between items-center p-2 bg-(--highlighted) rounded-lg hover:cursor-pointer hover:font-bold'>
                    ...
                    <span className='text-sm text-gray-500'>2 new messages</span>
                  </div>
                  <div className='flex flex-row justify-between items-center p-2 bg-(--highlighted) rounded-lg hover:cursor-pointer hover:font-bold'>
                    <span>Chat with Mentor 2</span>
                    <span className='text-sm text-gray-500'>No new messages</span>
                  </div>
                </div>
            ...
            <div className='flex flex-col items-center justify-center flex-wrap gap-2 p-4 w-[45vw] h-full overflow-y-auto'> {/* Chat window would go here */}
              <div className='hidden flex-col items-center justify-center gap-4 mb-10 h-full'> {/* No chat selected */}
                <p>Select a chat to start messaging.</p>
              </div>
              <div className='flex flex-col h-full'> {/* Chat selected */}
